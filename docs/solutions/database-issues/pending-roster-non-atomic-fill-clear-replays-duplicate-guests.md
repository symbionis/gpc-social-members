...
>
> **Update (2026-08-11): a second producer on this column was a bug, and has been removed.** For a few weeks the top-up route also wrote `event_registrations.pending_roster`, on an already-`paid` registration, which broke the one-producer assumption this whole doc rests on. Two ways to lose a paid seat's name followed:
>
