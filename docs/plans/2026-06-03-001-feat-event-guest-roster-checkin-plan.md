...
- **Patterns to follow:** `supabase/migrations/20260526130000_event_ticket_types.sql` (table + seed shape), `supabase/migrations/20260521120100_event_checkins_marketing_consent.sql` (additive column comment style).
- **Test scenarios:**
