...
const REACTIVATION_COOLDOWN_DAYS = 14;
...
export async function sendReactivationEmail(
  ...
  // Resolve originator: use the member's existing one if present and active,
  // otherwise fall back to Frank.
  ...
  // Mark sent so the cooldown applies. Best-effort: log if this fails but do
  // not fail the whole call — the email already went out.
